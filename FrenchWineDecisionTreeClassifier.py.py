...
# 输出模型的准确度
print("精度为："+str(decision_tree_classifier.score(X_test, Y_test)))
...
jieguo_en=model.predict([[13.52,3.17,2.72,23.5,97],[12.42,2.55,2.27,22,90],[13.76,1.53,2.7,19.5,132]])
dict={'Zinfandel':'仙粉黛','Syrah':'西拉','Sauvignon':'赤霞珠'}
jieguo = []
for i in range(0,len(jieguo_en)):
    jieguo.append(dict[jieguo_en[i]])
print("分类结果："+str(jieguo))
